...
Installing on Windows requires installing Go. If you already have the [Chocolatey](https://chocolatey.org) package manager installed, you can use the command below to install Go (aka Golang).
