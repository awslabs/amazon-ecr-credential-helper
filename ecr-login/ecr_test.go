...
func TestGetSuccess(t *testing.T) {
	...
	factory.NewClientFromRegionFn = func(region string) ecr.Client { return client }
	client.GetCredentialsFn = func(endpoint string) (*ecr.Auth, error) {
		if proxyEndpoint != endpoint {
			t.Fatalf("Expected proxy endpoint, got %q", endpoint)
		}
		return &ecr.Auth{
